...
const RegularForgot = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <ImageBackground
      source={require('../../assets/images/RegularForgotBackground.png')} // Add your background image
