...
const RegularUserScreen = ({ navigation }: { navigation: any }) => {
  return (
    <ImageBackground
      source={require('../../assets/images/RegularUserBackground.png')}
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPress={() => navigation.navigate('RegularSignup')}
        >
...
export default RegularUserScreen;